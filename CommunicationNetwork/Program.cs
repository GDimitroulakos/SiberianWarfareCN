...
namespace CommunicationNetwork
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Node1: {node1.Name},  Serial: {node1.Serial}");
            Console.WriteLine($"Node2: {node2.Name},  Serial: {node2.Serial}");
            Console.WriteLine($"Edge1: {edge1.Name},  Serial: {edge1.Serial}");
